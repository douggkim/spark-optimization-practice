...
object ReusingObjects {
  ...
  * */
  ...
  val textPath = "src/main/resources/generated/3m.txt"
  ...
  def collectStats() = {
    ...
    val aggregate = text.aggregateByKey(TextStats.zero)(aggregateNewRecord, combineStats)
  ...
  def collectStats2() = {
    ...
    val aggregate = text.aggregateByKey(MutableTextStats.zero)(aggregateNewRecord, combineStats)
    aggregate.collectAsMap()
  }
